...
function ProductOrderBlock() {
  ...
  async function handleSubmit(mode: "existing" | "new") {
    ...
    // JJ orders don't use priority / product group. Everyone else must pick one.
    if (!isJJ && !isRealProductGroup(selectedProductGroup)) {
  ...
  return (
    <BlockStack gap="small">
      ...
      {/* JJ orders don't use priority / product group. */}
      {!isJJ && (
      ...
      <InlineStack gap="base">
        ...
        <Button variant={order ? "secondary" : "primary"} disabled={(isJJ ? false : !hasProductGroup) || submitting} onPress={() => handleSubmit("new")}>
