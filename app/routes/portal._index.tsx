...
function CollectionSpreadsheetPage({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0, gap: 14 }}>
      ...
      <div className="portal-table-scroll" style={{ ...s.tableWrap, flex: 1, minHeight: 0, maxHeight: "calc(100vh - 115px - var(--portal-bottom-gap) - var(--portal-footer-actions))" }}>
        {!loaded ? (
...
const s: Record<string, React.CSSProperties> = {
  ...
  fabricTableWrap: {
    // 170 = top page chrome (filter + summary row) + main's top
    // 24px padding + main's 24px bottom padding so the table ends
